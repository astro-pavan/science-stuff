...
\begin{document}
    ...
    % \imageframe[title]{image}
    % title -- optional frame title
    % image -- path to image file; scaled to fit the content area, aspect ratio preserved
    \imageframe[Centred Image Slide: \texttt{\textbackslash imageframe}]{apj460815f8_hr.jpg}

    \textframe{\texttt{\textbackslash imageframe[title]\{image\}}}{
        ...
        \begin{itemize}
            ...
            \item \texttt{image} --- path to image file
            \item Scales to fit the content area with the aspect ratio preserved
        \end{itemize}
    }
    ...
    \splitframe[0.5\textwidth]{l}{Split Frame: Image Left --- \texttt{\textbackslash splitframe}}{apj460815f8_hr.jpg}{
        ...
        \begin{itemize}
            ...
            \item Works inside \texttt{darkslide}
        \end{itemize}
    }
    ...
    \textframe{\texttt{\textbackslash coverframe[crop]\{image\}}}{
        The previous slide was a \texttt{\textbackslash coverframe} --- a full-bleed image with no overlaid text.
        \vspace{0.8em}
        \begin{itemize}
            ...
            \item Add a \texttt{*} to show the header and footer bars: \texttt{\textbackslash coverframe*[crop]\{image\}}
        \end{itemize}
    }
    ...
    \textframe{\texttt{\textbackslash coverframe*} --- with Bars}{
        ...
        \begin{itemize}
            ...
            \item The theme colour bar and footer sit on top of the full-bleed image
        \end{itemize}
    }

    % \coversplitframe[width]{align}{crop}{title}{image}{content}
    ...
    \coversplitframe[0.45\paperwidth]{l}{p}{Cover Split: Text Left}{Earth_From_the_Perspective_of_Artemis_II.jpeg}{
        \textbf{\texttt{\textbackslash coversplitframe[w]\{align\}\{crop\}\{title\}\{img\}\{content\}}}
        \vspace{0.5em}
        ...
        \begin{itemize}
            ...
            \item Add \texttt{*} to show the header and footer bars
        \end{itemize}
    }
